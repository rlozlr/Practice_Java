...
public class Class03 {
	...
	public static void main(String[] args) {
		 ...
		 * - 클래스명.메서드/변수 호출 (객체를 통해서 호출이 가능하나 일반적이지 않다) 
		 * - 클래스 멤버변수는 하나의 멤버변수를 모든 객체가 공유(사용)한다. 
		 * - 모든 객체들이(하나의 클래스를 통해 생성되는 모든객체) 동일한 값을 사용한다면 static을 붙이는 것을 고려
		 * 
		 ...
		 * - 클래스 멤버메서드는 클래스/객체의 멤버에서 모두 사용할 수 있다.
		...
		t.printBrand();	// 클래스 멤버메서드 호출 (잘 쓰지 않는다.)
		System.out.println("-----------------");
